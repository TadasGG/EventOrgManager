...
public interface StoredItemsRepository extends JpaRepository<StoredItems, Long> {
    ...
    List<StoredItems> findByItemIdAndAvailability(Long itemId, Boolean availability);

    List<StoredItems> findByItemIdAndAvailabilityAndExternalRentalFalse(Long itemId, Boolean availability);
}
