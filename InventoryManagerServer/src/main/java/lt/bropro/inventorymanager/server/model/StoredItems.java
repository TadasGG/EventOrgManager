...
public class StoredItems {
    ...
    private boolean externalRental = false;
    ...
    public boolean getExternalRental() {
        return externalRental;
    }

    public void setExternalRental(boolean externalRental) {
        this.externalRental = externalRental;
    }
}
